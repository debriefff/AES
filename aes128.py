...
def sub_bytes(state, inv=False):
    ...
    for i in range(len(state)):
        for j in range(len(state[i])):
            ...
            box_elem = box[16*int(row) + int(col)]
            state[i][j] = box_elem
...
def mix_columns(state, inv=False):
    ...
    for i in range(nb):
        ...
        if inv == False: # encryption
            ...
            s0 = mul_by_0e(eval(state[0][i]))^mul_by_0b(eval(state[1][i]))^mul_by_0d(eval(state[2][i]))^mul_by_09(eval(state[3][i]))
            s1 = mul_by_09(eval(state[0][i]))^mul_by_0e(eval(state[1][i]))^mul_by_0b(eval(state[2][i]))^mul_by_0d(eval(state[3][i]))
            s2 = mul_by_0d(eval(state[0][i]))^mul_by_09(eval(state[1][i]))^mul_by_0e(eval(state[2][i]))^mul_by_0b(eval(state[3][i]))
            s3 = mul_by_0b(eval(state[0][i]))^mul_by_0d(eval(state[1][i]))^mul_by_09(eval(state[2][i]))^mul_by_0e(eval(state[3][i]))
